...
TABLE G(i,j) Investment Cost for Ships (Merged train parts with value 0 for not feasible parts)
        1       2       3       4       5
    1   40      60      0       40      80
    2   60      40      80      20      40
    3   0       0       80      60      100
...
cost.. sum(j,sum(i,x(i,j)*(F(i,j)+G(i,j)/20)))=e=z;

model assingment1b /all/;
solve assingment1b using lp minimizing  z;
display x.l,z.l;
